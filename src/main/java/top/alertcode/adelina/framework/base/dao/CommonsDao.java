...
import top.alertcode.adelina.framework.base.entity.BaseEntitySql;
import top.alertcode.adelina.framework.base.entity.EntitySqlTable;
import top.alertcode.adelina.framework.base.entity.OrderBySqlBase;
...
public interface CommonsDao {
     ...
     * @return
     */
    List<Map> listBaseEntity(@Param("baseSql") BaseEntitySql baseSql, @Param("orderBySql") OrderBySqlBase orderBySql);
